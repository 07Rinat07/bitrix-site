...
?>
        ...
        <head>
            ...
            Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/assets/js/vendor/modernizr-2.8.3.min.js');
            ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="welcome">
                            <span><i class="fa fa-envelope"></i> ura07srr@gmail.com</span>
                            <span><i class="fa fa-phone"></i> +77051260410</span>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
